using DotNetCore.EnterpriseTemplate.Domain.Validation;
using DotNetCore.EnterpriseTemplate.Unit.Domain.Entities.TestData;
using FluentValidation.TestHelper;
using Xunit;

namespace DotNetCore.EnterpriseTemplate.Unit.Domain.Validation;
